...
folder = 'experiments/imagenet/random/gen_reg'
if not os.path.isdir(folder):
    os.mkdir(folder)

folder = 'experiments/imagenet/random/gen_reg/inpainting'
if not os.path.isdir(folder):
    os.mkdir(folder)
...
for i in range(1,101):
  ...
  res = gr.gen_reg_successively(imname='imsource/imagenet/img_'+str(i)+'.png',
